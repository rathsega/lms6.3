...
$existed_segments = ["translate_uri_dashes","addons","bundle_details","default_controller", "certificate", "404_override","home", "ebook", "ebook_manager", "course_bundles", "my_bookings", "schedules_bookings", "tutor", "tutors", "page", "blogs","login","admin","payment","sign_up","blog","modal", "install", "assets", "excel_export"];
