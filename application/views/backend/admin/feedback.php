<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo "Feedback"; ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-inline" action="<?php echo base_url(); ?>excel_export/feedbacks" method="get">
                    <div class="col-xl-1">
        ...
        <div class="card">
            <div class="card-body">
              <div class="table-responsive-sm">
                  ...
                  <?php if (count($feedbacks->result_array()) > 0): ?>
                      <table id="basic-datatable" class="table table-striped table-centered mb-0" data-order="[[ 5, &quot;desc&quot; ]]">
                          ...
                          <tbody>
                              <?php foreach ($feedbacks->result_array() as $feedback):
                                    date_default_timezone_set('Asia/Kolkata');
                                  $user_data = $this->db->get_where('users', array('email' => $feedback['email']))->row_array();?>
                                  <tr class="gradeU"  style="color: <?php echo $user_data && $user_data['id'] ? 'green' : 'blue'; ?>;">
                                      <td>
                                            <b><?php echo $feedback['name']; ?></b><br>
