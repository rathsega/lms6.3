    ...
    <div class="row">
        <div class="col-md-7">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" id="meeting_invite_link" name = "meeting_invite_link" placeholder="<?php echo get_phrase('enter_meeting_invite_link'); ?>" value="<?php echo $live_class['meeting_invite_link']; ?>">
                </div>
            </div>
        </div>
        <div class="col-md-5">
