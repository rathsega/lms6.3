<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('courses')."&emsp;&emsp;&emsp;&emsp;"; ?>
                    ...
                    <button type="button" class="btn btn-outline-secondary btn-rounded btn-sm py-10" name="button" onclick="showLargeModal('<?php echo site_url('modal/popup/sort_top_courses'); ?>', 'Sort Top Courses')"><i class="mdi mdi-sort-variant"></i> <?php echo get_phrase('Sort Top Courses'); ?></button>
