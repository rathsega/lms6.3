...
$chapter_details = $this->crud_model->get_chapters('chapter', $param3)->row_array();
$lessons = $this->crud_model->get_lessons('chapter', $param3)->result_array();
?>
<div class="row">
    <div class="col-12">
        <div class="card">
                ...
                <div class="row" id = "parent-div" data-plugin="dragula" data-containers='["lesson-list"]'>
                    <div class="col-md-12">
                        <div class="bg-dragula p-2 p-lg-4">
                            <h5 class="mt-0"><?php echo get_phrase('sort_lessons_of').': '.$section_details['title'].' '.get_phrase('section') . ' -> ' . $chapter_details['title'] .' '.get_phrase('chapter'); ?>
