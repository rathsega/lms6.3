...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('generate_certificate'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
...
<div class="row justify-content-center">
    <div class="col-xl-7">
        <div class="card">
            <div class="card-body">
              <div class="col-lg-12">
                <h4 class="mb-3 header-title"><?php echo get_phrase('generate_certificate_form'); ?></h4>

                <form class="required-form" action="<?php echo site_url('admin/generate_certificate_manually'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="multiple_course_id"><?php echo get_phrase('course_to_generate_certificate'); ?><span class="required">*</span> </label>
                    ...
                    <button type="button" class="btn btn-primary" onclick="checkRequiredFields()"><?php echo get_phrase('generate_certificate'); ?></button>
                </form>
              </div>
            </div> <!-- end card body-->
        </div> <!-- end card -->
...
<?php
//$this->api_model->certificate_addon_get($user_id, $course_id);
