...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo 'Pause User'; ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
...
<div class="row justify-content-center">
    <div class="col-xl-7">
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    <h4 class="mb-3 header-title"><?php echo get_phrase('Pause User'); ?></h4>
                    ...
                    <form class="required-form" action="<?php echo site_url('admin/modify_user_status'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <label class="col-md-5 col-form-label" for="from_date"><?php echo get_phrase('from_date'); ?> <span class="required">*</span> </label>
                            <div class="col-md-7">
                                <input type="date" class="form-control"  min="<?= date('Y-m-d'); ?>" id="from_date_picker" value="<?= date('Y-m-d'); ?>" name="from_date" placeholder="<?php echo get_phrase('enter_from_date'); ?>" required>
                            </div>
                        </div>
                ...
                success: function(response) {
                    $.each(response.data, function(key, value) {
                        ...
                        if(value.status == 3){
                            ...
                            $('#from_date_picker').prop('disabled', 'disabled');
                        }else{
                            $('#from_date_picker').removeAttr('disabled');
