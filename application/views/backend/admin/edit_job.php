                ...
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('admin/update_job/' . $job['id']); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description1" required><?php echo set_value('description', $job['description']); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="employment_type" required class="select2 form-control select2-multiple">
                                ...
                                <option value="Freelance" <?php echo set_select('employment_type', 'Freelance', $job['employment_type'] == 'Freelance'); ?>>Freelance</option>
                                <option value="Internship" <?php echo set_select('employment_type', 'Internship', $job['employment_type'] == 'Internship'); ?>>Internship</option>
                            </select>
                        </div>
                        <div class="form-group">
                                ...
                                <?php 
                                    $selected_locations = explode(',',$job['location']);
                                     foreach($selected_locations as $loc): ?>
                                        <span class="location-item"><?php echo $loc; ?><input type="hidden" name="locations[]" value="<?php echo $loc; ?>"><button type="button" class="remove-location">x</button></span>
                                    <?php endforeach;
                                ?>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="min_pay_scale" class="form-control" placeholder="Minimum Pay Scale" value="<?php echo set_value('min_pay_scale', $job['min_pay_scale']); ?>">
                            </div>
                            <div class="col-lg-6">
                                <input type="text" name="max_pay_scale" class="form-control" placeholder="Maximum Pay Scale" value="<?php echo set_value('max_pay_scale', $job['max_pay_scale']); ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="min_experience" class="form-control" placeholder="Minimum Experience" required value="<?php echo set_value('min_experience', $job['min_experience']); ?>">
                            </div>
                            <div class="col-lg-6">
                                <input type="text" name="max_experience" class="form-control" placeholder="Maximum Experience" required value="<?php echo set_value('max_experience', $job['max_experience']); ?>">
                            </div>

                        </div>
                        <div class="form-group">
                            <?php
                            $existes_qualifications = json_decode($job['qualification']);
                            ?>
                            ...
                            <select id="qualification" name="qualification[]" multiple  class="form-control" required>
                                <?php foreach ($qualifications as $qualification) : ?>
                                    <option <?php echo in_array($qualification, $existes_qualifications) ? 'selected' : ""; ?> value="<?= htmlspecialchars($qualification) ?>"><?= htmlspecialchars($qualification) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <?php
                                ...
                                foreach($skills as $skill): ?>
                                    <span class="skill-item"><?php echo $skill; ?><input type="hidden" name="required_skills[]" value="<?php echo $skill; ?>"><button type="button" class="remove-skill">x</button></span>
                                <?php endforeach;
                            ?>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="work_mode" required class="select2 form-control select2-multiple">
                                ...
                                <option value="Work from office" <?php echo set_select('work_mode', 'Work from office', $job['work_mode'] == 'Work from office'); ?>>Work from office</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" name="industry" id="industry" required>
                                ...
                                <?php foreach ($industries->result_array() as $industry) : ?>
                                            <option value="<?php echo $industry['industry_name']; ?>" <?php echo set_select('industry', $industry['industry_name'], $job['industry'] == $industry['industry_name']); ?>><?php echo $industry['industry_name']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if($job['og_banner']) : ?>
                                <div class="form-group row mb-3" id="current_og_banner">
                                    <label class="col-md-5 col-form-label" for="og_banner">Current Banner</label>
                                    <div class="col-md-7">
                                        <a download href="<?php echo base_url('uploads/jobs/banner/') . $job['og_banner']; ?>">download</a>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php if($job['logo']) : ?>
                                <div class="form-group row mb-3" id="current_logo">
                                    <label class="col-md-5 col-form-label" for="logo">Current Banner</label>
                                    <div class="col-md-7">
                                        <a download href="<?php echo base_url('uploads/jobs/logo/') . $job['logo']; ?>">download</a>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
