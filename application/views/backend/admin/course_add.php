                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="course_duration_in_months" name = "course_duration_in_months" placeholder="02 Months" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="daily_class_duration_in_hours" name = "daily_class_duration_in_hours" placeholder="02 Hours" >
                                                    </div>
                                                </div>
                                            </div>
