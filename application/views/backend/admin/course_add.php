                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div class="col-xl-8">
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="course_duration_in_months" name="course_duration_in_months" placeholder="2.5">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xl-8">
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="daily_class_duration_in_hours" name="daily_class_duration_in_hours" placeholder="2">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="group">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-8">
                                                                <select name="company[0][]" class="form-control select2" data-toggle="select2" multiple>
