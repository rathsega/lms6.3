                                ...
                                <div class="course-popover-content">
                                    ...
                                    <div class="popover-btns">
                                        <?php if (is_purchased($top_course['id'])) : ?>
                                            <div class="d-flex" >
                                                <div class="purchased w-100">
                                                    <a href="<?php echo site_url('home/my_courses'); ?>"><?php echo site_phrase('already_purchased'); ?></a>
                                                </div>

                                                <!-- send gift button -->
                                                <button type="button" class="buy-as-gift-btn" style="margin-top :18px;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo site_phrase('buy_as_gift'); ?>" id="topcourse_<?php echo $top_course['id']; ?>" onclick="handleGiftItem(<?php echo $top_course['id']; ?>)" ><i class="fas fa-gift"></i></button>
    ...
    <div class="container-lg">
        <div class="row">
            <div class="col">
                ...
                <div class="course-carousel shown-after-loading" style="display: none;">
                    <?php
                    $latest_courses = $this->crud_model->get_top_10_course();
                                    ...
                                    <div class="popover-btns">
                                        <?php if (is_purchased($latest_course['id'])) : ?>
                                            ...
                                            <div class="d-flex" >
                                                ...
                                                <!-- send gift button -->
                                                <button type="button" class="buy-as-gift-btn" style="margin-top :18px;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo site_phrase('buy_as_gift'); ?>" id="latestcourse_<?php echo $latest_course['id']; ?>" onclick="handleGiftItem(<?php echo $top_course['id']; ?>)" ><i class="fas fa-gift"></i></button>
...
function handleGiftItem(course_id) {
