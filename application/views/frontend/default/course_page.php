          ...
          <div class="course-sidebar-text-box">
            ...
            <?php if (is_purchased($course_details['id'])) : ?>
              <div class="d-flex">
                ...
                <div class="already_purchased me-5 w-100">
                  <a href="<?php echo site_url('home/my_courses'); ?>"><?php echo site_phrase('already_purchased'); ?></a>
                </div>
                <button type="button" class="buy-as-gift-btn mx-3" style="margin-top :18px;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo site_phrase('buy_as_gift'); ?>" id="course_<?php echo $course_details['id']; ?>" onclick="handleGift(this)" ><i class="fas fa-gift"></i></button>
              </div>
            <?php else : ?>
            ...
            <div class="includes">
              ...
              <ul>
                ...
                <?php else: ?>
                  <li><i class="far fa-file-video"></i><?php echo site_phrase($course_details['course_type']).' '.site_phrase('course'); ?></li>
                  <li><i class="fas fa-mobile-alt"></i><?php echo site_phrase('access_on_laptop_and_tv'); ?></li>
                <?php endif; ?>
                <li><i class="far fa-compass"></i><?php echo site_phrase('one_year_access'); ?></li>
