            ...
            <div class="sign-up-form">
              ...
              <form action="<?php echo site_url('login/register'); ?>" method="post" id="sign_up">
                <div class="form-group">
                  <label for="first_name"><?php echo site_phrase('first_name'); ?><span class="required">*</span> </label>
                ...
                <div class="form-group">
                  <label for="last_name"><?php echo site_phrase('last_name'); ?><span class="required">*</span> </label>
                  <div class="input-group">
                ...
                <div class="form-group">
                  <label for="registration-password"><?php echo site_phrase('phone_number'); ?><span class="required">*</span> </label>
                  <div class="input-group">
                    <span class="input-group-text bg-white" for="phone_number"><i class="fas fa-phone"></i></span>
                    <input type="text" name="phone_number" pattern="[\+]?\d{0,3}[\-]?\d{10}" class="form-control" placeholder="<?php echo site_phrase('phone_number'); ?>" aria-label="<?php echo site_phrase('password'); ?>" aria-describedby="<?php echo site_phrase('password'); ?>" id="registration-password" required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="registration-email"><?php echo site_phrase('email'); ?><span class="required">*</span> </label>
                  <div class="input-group">
                ...
                <div class="form-group">
                  <label for="registration-password"><?php echo site_phrase('password'); ?><span class="required">*</span> </label>
                  <div class="input-group">
