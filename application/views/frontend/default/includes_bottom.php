...
<script src="<?php echo base_url() . 'assets/frontend/default/js/toastr.js'; ?>"></script>
...
<?php if ($this->session->flashdata('alert_message') != "") : ?>
	...
	<script type="text/javascript">
		toastr.expiryAlert('<?php echo $this->session->flashdata("alert_message"); ?>', 'Alert !', {extendedTimeOut:0,timeOut:0});
	</script>
