                    ...
                    <div class="col-md-3 text-center fw-500 text-14px">
                        <?php if (isset($course_1_details['id'])) : ?>
                            ...
                            <?php if (is_purchased($course_1_details['id'])) : ?>
                                ...
                                <!-- send gift button -->
                                <br>
                                <button type="button" class="buy-as-gift-btn" style="margin-top :18px; position: inherit;"  data-bs-toggle="tooltip" data-bs-placement="right" title="<?php echo site_phrase('buy_as_gift'); ?>" id="course_<?php echo $course_1_details['id']; ?>" onclick="handleGift(this)" ><i class="fas fa-gift"></i></button>
                    ...
                    <div class="col-md-3 text-center fw-500 text-14px">
                        <?php if (isset($course_2_details['id'])) : ?>
                            ...
                            <?php if (is_purchased($course_2_details['id'])) : ?>
                                ...
                                <!-- send gift button -->
                                <br>
                                <button type="button" class="buy-as-gift-btn" style="margin-top :18px; position: inherit;"  data-bs-toggle="tooltip" data-bs-placement="right" title="<?php echo site_phrase('buy_as_gift'); ?>" id="course_<?php echo $course_2_details['id']; ?>" onclick="handleGift(this)" ><i class="fas fa-gift"></i></button>
                            <?php else : ?>
                                <?php if ($course_2_details['is_free_course'] == 1) : ?>
                                    <?php if ($this->session->userdata('user_login') != 1) : ?>
                                        <a href="#" class="btn red radius-5 mt-3 py-2" onclick="handleEnrolledButton()"><?php echo site_phrase('get_enrolled'); ?></a>
                    ...
                    <div class="col-md-3 text-center fw-500 text-14px">
                        <?php if (isset($course_3_details['id'])) : ?>
                            ...
                            <?php if (is_purchased($course_3_details['id'])) : ?>
                                ...
                                <!-- send gift button -->
                                <br>
                                <button type="button" class="buy-as-gift-btn" style="margin-top :18px; position: inherit;"  data-bs-toggle="tooltip" data-bs-placement="right" title="<?php echo site_phrase('buy_as_gift'); ?>" id="course_<?php echo $course_3_details['id']; ?>" onclick="handleGift(this)" ><i class="fas fa-gift"></i></button>
                            <?php else : ?>
                                <?php if ($course_3_details['is_free_course'] == 1) : ?>
                                    <?php if ($this->session->userdata('user_login') != 1) : ?>
                                        <a href="#" class="btn red radius-5 mt-3 py-2" onclick="handleEnrolledButton()"><?php echo site_phrase('get_enrolled'); ?></a>
...
<script type="text/javascript">
    ...
    function handleGift(elem) {
      ...
      url1 = '<?php echo site_url('home/handleCartItemForBuyNowButton'); ?>';
      urlToRedirect = '<?php echo site_url('home/shopping_cart/gift'); ?>';
      var explodedArray = elem.id.split("_");
      var course_id = explodedArray[1];
