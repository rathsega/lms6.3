            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="title-one pb-20">
                        ...
                        <h4 class="title"><?php echo ucwords(get_phrase('Upcoming courses')); ?></h4>
                        <div class="bar"></div>
                    </div>
...
<section class="courses grid-view-body pt-50 pb-4">
    <div class="container top_courses">
        <h1><span><?php echo ucwords(site_phrase('top_courses')); ?></span></h1>
...
<section class="top-categories">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h1 class="text-center mt-4"><?php echo ucwords(site_phrase('top_categories')); ?></h1>
...
<section class="courses grid-view-body pb-4">
    <div class="container top_10_latest_courses">
        <h1 class="text-center"><span><?php echo site_phrase('top') . ' 10 ' . ucwords(site_phrase('latest_courses')); ?></span></h1>
    ...
    <section class="expert-instructor top-categories pb-3 ">
        <div class="container">
            <div class="row">
                <div class="col-lg-3"></div>
                <div class="col-lg-6">
                    <h1 class="text-center mt-4"><?php echo ucwords(get_phrase('Top Instructors')) ?></h1>
    ...
    <section class="expert-instructor top-categories pb-3 performance-hide">
        <div class="container">
            <div class="row">
                <div class="col-lg-3"></div>
                <div class="col-lg-6">
                    <h1 class="text-center mt-4"><?php echo ucwords(get_phrase('Think more clearly')); ?></h1>
...
<?php if (get_frontend_settings('blog_visibility_on_the_home_page') && $latest_blogs->num_rows() > 0) : ?>
    <section class="courses blog performance-hide">
        <div class="container latest_blogs">
            <h1 class="text-center"><span><?php echo 'Visit Our Latest Blogs'; ?></span></h1>
