...
.nb-form:hover #userIcon {
    content: url('https://res.cloudinary.com/dc2uykpox/image/upload/v1709106699/Group_1000002062_xw39ma.png'); /* Change the source for the hover state */
}
/* .nb-form .user-icon {
    position: absolute;
    top: -49px;
...
.nb-form textarea {
    ...
    border-radius: 4px;
    color: #000000;
    border-bottom: 1px solid #cbc3f1;
}
