<script defer src="<?php echo base_url() . 'assets/frontend/default-new/js/bootstrap.bundle.min.js'; ?>"></script>
...
<script src="<?php echo base_url() . 'assets/frontend/default-new/js/script.min.js'; ?>"></script>
<script defer src="<?php echo base_url() . 'assets/frontend/default-new/summernote-0.8.20-dist/summernote-lite.min.js'; ?>"></script>
