	                ...
	                <div class="card">
	                    ...
	                    <div class="d-flex">
	                        ...
	                        <?php elseif($course_1_details['discount_flag']): ?>
	                            ...
	                            <h6 class="ms-1" style="margin-top: 2px"><del><?php echo currency($course_1_details['price']); ?></del><span><?php echo " +Taxes"; ?></span></h6>
	                        <?php else: ?>
	                            <h3><?php echo currency($course_1_details['price']); ?><span><?php echo " +Taxes"; ?></span></h3>
	                        <?php endif; ?>
	                    </div>
	                ...
	                <div class="card">
	                    ...
	                    <div class="d-flex">
	                        ...
	                        <?php elseif($course_2_details['discount_flag']): ?>
	                            ...
	                            <h6 class="ms-1" style="margin-top: 2px"><del><?php echo currency($course_2_details['price']); ?></del><span><?php echo " +Taxes"; ?></span></h6>
	                        <?php else: ?>
	                            <h3><?php echo currency($course_2_details['price']); ?><span><?php echo " +Taxes"; ?></span></h3>
	                        <?php endif; ?>
	                    </div>
	                ...
	                <div class="card">
	                    ...
	                    <div class="d-flex">
	                        ...
	                        <?php elseif($course_3_details['discount_flag']): ?>
	                            ...
	                            <h6 class="ms-1" style="margin-top: 2px"><del><?php echo currency($course_3_details['price']); ?></del><span><?php echo " +Taxes"; ?></span></h6>
	                        <?php else: ?>
	                            <h3><?php echo currency($course_3_details['price']); ?><span><?php echo " +Taxes"; ?></span></h3>
	                        <?php endif; ?>
	                    </div>
                    ...
                    <tr>
                      ...
                      <td>
                      	...
                      	if(isset($course_1_details['title'])):
							$ratings_count = $this->crud_model->get_ratings_count($course_1_details['id']);
                            if($ratings_count){
                      ...
                      <td>
                      	...
                      	if(isset($course_2_details['title'])):
							$ratings_count = $this->crud_model->get_ratings_count($course_2_details['id']);
                            if($ratings_count){
                                $one = $ratings_count['one_rating_count'];
                                $two = $ratings_count['two_rating_count'];
                                $three = $ratings_count['three_rating_count'];
                      ...
                      <td>
                      	...
                      	if(isset($course_3_details['title'])):
							$ratings_count = $this->crud_model->get_ratings_count($course_3_details['id']);
                            if($ratings_count){
                                $one = $ratings_count['one_rating_count'];
                                $two = $ratings_count['two_rating_count'];
                                $three = $ratings_count['three_rating_count'];
