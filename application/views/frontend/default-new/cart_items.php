...
<?php foreach($cart_items as $cart_item): 
	...
	<?php $course_details = $this->crud_model->get_course_by_id($cart_item)->row_array(); 
		if($course_details['slug_count'] == 1 || $course_details['slug_count'] == 2){
			$cart_item_slug = $course_details['slug'];
		}else if($course_details['slug_count'] == 3 || $course_details['slug_count'] == 4){
			$cart_item_slug = $course_details['category_slug'] .'/' . $course_details['sub_category_slug'] .'/' . $course_details['slug'];
		}else{
			$cart_item_slug = $course_details['slug'];
		}
	?>
	...
	<div class="path_pos_wish-2">
	  <div class="path_pos_wish">
	    <div class="menu_pro_wish-f-b">
	      <a href="<?php echo site_url($cart_item_slug); ?>" class="checkPropagation">
	          ...
	          <div class="text">
	            ...
	            <div class="spandiv">
	                ...
	                <?php elseif($course_details['discount_flag']): ?>
	                    <span><?php echo currency($course_details['discounted_price']); ?><span><?php echo " +Taxes"; ?></span></span>
	                    <del><?php echo currency($course_details['price']); ?><span><?php echo " +Taxes"; ?></span></del>
	                <?php else: ?>
	                    <span><?php echo currency($course_details['price']); ?><span><?php echo " +Taxes"; ?></span></span>
	                <?php endif; ?>
	            </div>
	          </div>
	        </div>
