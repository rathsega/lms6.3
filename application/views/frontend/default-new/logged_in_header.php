...
<header>
    ...
    <section class="menubar">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <!-- <a class="navbar-brand logo" href="#"><img src="<?php// echo base_url('uploads/system/'.get_frontend_settings('dark_logo')); ?>" alt=""></a> -->
                <a class="navbar-brand logo" href="<?php echo site_url(''); ?>"><img src="<?php echo base_url('assets/frontend/default-new/image/logo.png')?>" alt=""></a>
...
<div class="mood-control">
        <a href="#"> <img id="dark" src="image/moon.png" alt="moon"></a>
     </div>