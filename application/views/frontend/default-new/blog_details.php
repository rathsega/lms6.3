        ...
        <div class="courses-card">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="cirriculum-card">
                         <div class="row">
                            <div class="col-md-4 col-sm-12">
                              <div >
                              <img class="girl-blog" src="<?php echo base_url("assets/frontend/default-new/image/blog-girl.jpg");?>" >
                              </div>
                            </div>
                            <div class="col-md-8 col-sm-12">
                             <div>
                            <h6 class="text-white blog-h">Tech Leads IT Events Training Certification</h6>
                            <ul class=" list-inline pt-2" >
                                <span class="certi-para"><i class="fa-solid fa-arrow-right"></i>  Master Your Craft</span>
                                <span class="certi-para"><i class="fa-solid fa-arrow-right"></i>  Lifetime LMS & Faculty Access</span>
                                <span class="certi-para"><i class="fa-solid fa-arrow-right"></i>  24/7 online expert support</span>
                                <span class="certi-para"><i class="fa-solid fa-arrow-right"></i>  Real-world & Project Based</span>
                                <span class="certi-para"><i class="fa-solid fa-arrow-right"></i>  Learning</span>
                            </ul>
                             </div>
                             <div class="text-center pt-3">
                                <a href="#!" class="exp-btn btn btn-light">Explore Curriculum</a>
                            </div>
                            </div>
                    ...
                    <div class="youtube-card pt-4 pb-4 mt-5">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                 <div class="pb-3">
                                 <img src="http://localhost/lms/uploads/system/ff276aba80ec3e26adc022017e3b8b21.png" alt="" class="techleads-og">
                                 </div>
                                 <div>
                                    <h4 class="text-light youtube-h">Subscribe to our YouTube channel to get new updates..!</h3>
                                 </div>
                                 <div class="text-center pt-3">
                                 <a href="#!" class="youtube-btn btn btn-dark px-4">Subscribe</a>
                                 </div>
                            </div>
                    ...
                    <div class="cirriculum-card pt-4 pb-4 mt-5">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                 <div>
                                    <h4 class="text-light youtube-h ">Tech Leads IT Events Training Certification</h3>
                                    <h6 class="bussines-para pt-2 pb-4">Weekday / Weekend Batches</h6>
                                 </div>
                                 <div class="text-center">
                                 <a href="#!" class="youtube-btn btn btn-dark px-3">Search Batch Details</a>
                                 </div>
                            </div>
                        </div>
                    </div>
                    <div class="cirriculum-frm pt-4 pb-4 mt-5">
                      <h5 class="text-light">Get 100% Hike!</h5>
                      <h6 style="font-size:14px;" class="text-light pt-2">Master Most in Demand Skills Now !</h6>
                                <div class="row">
                                ...
                                <div class="text-end">
                                 <a href="#!" class="youtube-btn btn btn-dark px-5" style="font-size:15px;">Submit</a>
                                 </div>
                                </div>
                    </div>
