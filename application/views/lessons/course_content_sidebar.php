                ...
                <!-- ZOOM LIVE CLASS TAB STARTS-->
                    ...
                    <div class="tab-pane fade" id="liveclass" role="tabpanel" aria-labelledby="liveclass-tab" style="text-align: center;">
                        <?php
                            ...
                            $msg = `<div class="alert alert-warning" role="alert" style="padding: 30px 0px;">
                        ...
                        <?php if (addon_status('live-class')): ?>
                            ...
                            if ($live_class->num_rows() > 0):
                                ...
                                $live_class_time = date('d M Y ', $live_class['date']).date('h:i a', $live_class['time']);
		                        $live_class_end_time = $live_class['end_date'];
		
                                    if (count($live_class) > 0 && strtotime($live_class_time) <= (time()+19800) && $live_class_end_time >= (time()+19800)):
                                        //$live_class = $live_class->row_array();
                                        $has_upcoming_live_class = 1;
                                    endif;
                                ?>
                                <?php if($has_upcoming_live_class): ?>
                                    <div style="padding: 30px 0px;">
                                        <i class="fa fa-calendar-check"></i> <?php echo get_phrase('zoom_live_class_schedule'); ?>
                                        <h5 style="margin-top: 20px;"><?php  echo $has_upcoming_live_class ?  date('h:i A', strtotime($live_class_time)) ." ". date('d M Y', time()+19800) : $msg; ?></h5>
                        ...
                        <?php if (addon_status('jitsi-live-class')): ?>
                            ...
                            if ($live_class->num_rows() > 0):
                                ...
                                if($has_upcoming_live_class == 1 && strtotime($live_class_time) > strtotime($live_class_time)){
                                    $live_class_time = $live_class_time;
